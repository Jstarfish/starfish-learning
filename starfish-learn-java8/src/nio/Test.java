...
/**
 * @description: 多个文件处理，边读边写
 * @author: starfish
 * @create: 2020-05-21 14:06
 **/
public class Test {
        ...
        public static void main(String args[]) throws Exception {
            ...
            File dir = new File("H:\\data\\test");
            //File dir = new File("H:\\data\\taobao");
            //File dir = new File(DATAPATH);
            List<File> files = (List<File>) FileUtils.listFiles(dir, null, true);

            for (File fin : files) {
                int bufSize = 1024;//一次读取的字节长度
                //File fin = new File("H:\\data\\taobao\\000624_0");//读取的文件
                //File fin = new File("H:\\data\\test\\1.txt");

                File fout = new File("H:\\data\\taobao\\00000002");//写出的文件
